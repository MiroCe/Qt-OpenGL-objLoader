...
int objmtlloader::Load(char* filename, int loadtype){
    char line[100];
    char mark[5];
    char tmp[50];
    char mtllib[20];
    ...
    char fullname[100];
    sprintf(fullname,"%s%s",filehead,filename);
...
int objmtlloader::LoadMTL(char* mtllib){
    char *pch;
    char line[100];
    ...
    char fullname[100];
    sprintf(fullname,"%s%s%s",filehead,"/",mtllib);
...
GLuint objmtlloader::LoadBMP(char *filename)
{
    GLuint tex_id;
    GLint alignment;
    ...
    char fullname[100];
    sprintf(fullname,"%s%s%s",filehead,"/",filename);
    buf.load(fullname);
    printf("%s\n", fullname);
...
void objmtlloader::Draw(int f_type){
    glPushMatrix();
